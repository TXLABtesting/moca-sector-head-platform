...
export const SEED_USERS: SeedUser[] = [
  ...
  { id: 'moza', name: 'موزة المرزوقي', job: 'مسؤولة الصادر والوارد والمتابعات', type: 'office', scope: 'office', img: 'assets/team/moza.jpg', g: { dashboard: 'v', correspondence: 'vaemsrn', myTasks: 've', assistant: 'v' } },
  ...
  { id: 'fatma', name: 'فاطمه الرشيدى', job: 'مسؤولة المشاريع والتنسيق التنفيذي', type: 'office', scope: 'office', img: 'assets/team/fatma.jpg', g: { dashboard: 'v', projects: 'vaemsrn', projPhases: 'vae', projUpdates: 'vaer', projRisks: 'vae', myTasks: 've', meetings: 'v', minutes: 'v', assistant: 'v' } },
  { id: 'hagar', name: 'هاجر هلول', job: 'مسؤولة الإنجاز والمتابعة والتقارير المالية', type: 'office', scope: 'office', img: 'assets/team/hagar.jpg', g: { dashboard: 'v', finReports: 'vaemrn', reportLog: 'vae', myTasks: 've', assistant: 'v' } },
