...
export const SEED_USERS: SeedUser[] = [
  ...
  { id: 'samah', name: 'سماح أبو شرخ', job: 'مسؤولة المحاضر واللجان والتوصيات والإجازات', type: 'office', scope: 'all', img: 'assets/team/samah.jpg', g: { dashboard: 'v', chairApproval: 'r', meetings: 'vaer', minutes: 'vaemrn', minuteTasks: 'vaesr', committees: 'vaemr', committeeDecisions: 'vaer', recommendations: 'vaer', leaves: 'vaesrn', myTasks: 've', assistant: 'v' } },
