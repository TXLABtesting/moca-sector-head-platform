...
export const WORK_ITEMS: WorkItem[] = [
  { id: 'wi1', owner: 'samah', section: 'minutes', title: 'محضر اجتماع القطاع الأسبوعي', status: 'بانتظار اعتماد رئيس القطاع', date: '2 يوليو 2026' },
  { id: 'wi2', owner: 'samah', section: 'committeeDecisions', title: 'قرار اللجنة التوجيهية لأمن المعلومات (24/2026)', status: 'بانتظار اعتماد رئيس القطاع', date: '1 يوليو 2026' },
  ...
  { id: 'mo1', owner: 'moza', section: 'correspondence', title: 'خطاب توحيد إجراءات المكتب (صادر)', status: 'بانتظار اعتماد رئيس القطاع', date: '2 يوليو 2026' },
  ...
  { id: 'fa1', owner: 'fatma', section: 'projUpdates', title: 'تحديث مشروع توحيد إجراءات المكتب', status: 'بانتظار اعتماد رئيس القطاع', date: '1 يوليو 2026' },
  ...
  { id: 'ha1', owner: 'hagar', section: 'finReports', title: 'التقرير المالي الشهري — يونيو 2026', status: 'بانتظار اعتماد رئيس القطاع', date: '1 يوليو 2026' },
  { id: 'ha2', owner: 'hagar', section: 'reportLog', title: 'متابعة استلام تقرير الدفعات المستبقاة', status: 'قيد التحديث', date: '30 يونيو 2026' },
  { id: 'sa1', owner: 'saif', section: 'projUpdates', title: 'تحديث مشروع الخدمات الذكية والبنية الرقمية', status: 'بانتظار اعتماد رئيس القطاع', date: '1 يوليو 2026' },
  { id: 'sa2', owner: 'saif', section: 'projPhases', title: 'مرحلة «الإطلاق» — مشروع البنية الرقمية', status: 'مسودة', date: '29 يونيو 2026' },
  { id: 'hs1', owner: 'hasan', section: 'auditReports', title: 'تقرير المتابعة والتدقيق الربعي', status: 'بانتظار اعتماد رئيس القطاع', date: '1 يوليو 2026' },
